...
import com.riverside.skeleton.android.widget.adapter.viewholders.RecyclerViewHolder;
...
public abstract class RecyclerAdapter<D> extends RecyclerView.Adapter<RecyclerViewHolder> {
    ...
    protected View inflateItemView(ViewGroup viewGroup, int viewType) {
        ...
        return LayoutInflater.from(context).inflate(itemLayout, viewGroup, false);
    }
