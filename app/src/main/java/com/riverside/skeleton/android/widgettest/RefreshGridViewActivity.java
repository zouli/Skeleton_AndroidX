...
import com.riverside.skeleton.android.widget.containers.RefreshGridView;
...
@EActivity(R.layout.activity_refresh_gridview)
public class RefreshGridViewActivity extends BaseActivity {
    ...
    void initList() {
        ...
        rgv.setOnBindDataListener(new RefreshAbsListView.BindDataListener() {
            @Override
                ...
                RetrofitBindHelper.getInstance().doBind(CommonRestService.class).getList(param)
                        ...
                        .subscribe(new RestSubscriber<List<String>>() {
                            ...
                            public void onComplete() {
                                rgv.setRefreshing(false);
                            }
                        });
            }
        });
        rgv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
